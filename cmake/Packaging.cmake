...
if (NOT PACKAGE_NAME)
    if (ENABLE_PACKAGING OR BUILD_RPM)
        ...
        configure_file(${MATIO_SOURCE_DIR}/README    README      COPYONLY)
        ...
        set(SYSTEMDIR ${SYSTEMDIR}-${CMAKE_SYSTEM_PROCESSOR})
        ...
        set(PACKAGE_NAME "matio-${PACKAGE_VERSION_MAJOR}.${PACKAGE_VERSION_MINOR}.${PACKAGE_VERSION_PATCH}-${SYSTEMDIR}")
