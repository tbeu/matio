...
[
    ...
    then
        ...
        AC_DEFINE_UNQUOTED(HAVE_MAT_INT32_T)
        AC_DEFINE_UNQUOTED([_mat_int32_t],[int32_t])
    ...
    then
        ...
        then
            AC_DEFINE_UNQUOTED(HAVE_MAT_INT32_T)
            AC_DEFINE_UNQUOTED([_mat_int32_t],[signed char])
    ...
    then
        ...
        then
            AC_DEFINE_UNQUOTED(HAVE_MAT_INT32_T)
            AC_DEFINE_UNQUOTED([_mat_int32_t],[short])
            AC_MSG_RESULT([short])
        fi
    fi
    if test "x$ac_have_mat_int32_t" != "xyes"
    then
        ...
        then
            AC_DEFINE_UNQUOTED(HAVE_MAT_INT32_T)
            AC_DEFINE_UNQUOTED([_mat_int32_t],[int])
            AC_MSG_RESULT([int])
        fi
    fi
    if test "x$ac_have_mat_int32_t" != "xyes"
    then
        ...
        then
            AC_DEFINE_UNQUOTED(HAVE_MAT_INT32_T)
            AC_DEFINE_UNQUOTED([_mat_int32_t],[long])
            AC_MSG_RESULT([long])
        fi
    fi
    if test "x$ac_have_mat_int32_t" != "xyes"
    then
        ...
        then
            AC_DEFINE_UNQUOTED(HAVE_MAT_INT32_T)
            AC_DEFINE_UNQUOTED([_mat_int32_t],[long long])
